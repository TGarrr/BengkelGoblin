                ...
                <tbody>
                    ...
                    foreach ($anggota as $a) { ?>
                        <tr>
                            ...
                            <!-- <td><a href="<? ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a> <a href="<? ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $str['kode']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a> </td> -->
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
