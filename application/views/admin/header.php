...
<head>
    <title>Dashboard - Aplikasi Bengkel Goblin</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url() . 'sparepart'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Sparepart</a></li>
